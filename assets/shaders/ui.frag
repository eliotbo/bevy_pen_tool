...
// layout(set = 2, binding = 0) uniform UiMat_color{
//     vec4 color;
// };

// layout(set = 2, binding = 1) uniform UiMat_t{
//     float t;
// };
// layout(set = 2, binding = 2) uniform UiMat_zoom{
//     float zoom;
// };
// layout(set = 2, binding = 3) uniform UiMat_size{
//     vec2 size;
// };
// layout(set = 2, binding = 4) uniform UiMat_clearcolor{
//     vec4 clear_color;
// };
// layout(set = 2, binding = 5) uniform UiMat_hovered{
//     float hovered;
// };
